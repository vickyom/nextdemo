...
var BMSApi = function () {
    ...
    _createClass(BMSApi, null, [{
        ...
        value: function getAllMovies() {
            return __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get('https://api.themoviedb.org/3/movie/now_playing?api_key=e2df83ac84acb977bef0b1fd007c11ad&language=en-US&page=1');
        }
    }, {
        key: 'getAllEvents',
...
function loadMovs() {
    return function (dispatch, getState) {
        ...
        return axios.get('https://api.themoviedb.org/3/movie/now_playing?api_key=e2df83ac84acb977bef0b1fd007c11ad&language=en-US&page=1').then(function (json) {
...
//# sourceMappingURL=4.73f8b6e62fdbb5241296.hot-update.js.map